...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "mbohoumounpouyvanlandry@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className="font-sans z-10 text-sm font-extralight text-[#C1C2D3] md:max-w-32 md:text-xs lg:text-base">
            {description}
          </div>
          {/* add text-3xl max-w-96 , remove text-neutral-600 dark:text-neutral-300*/}
          {/* remove mb-2 mt-2 */}
          <div
            className={`font-sans z-10 max-w-96 text-lg font-bold lg:text-3xl`}
          >
            {title}
          </div>
